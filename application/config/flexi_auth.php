...
*/
	...
	*/
	$config['security']['recaptcha_public_key']	= '6LcdGusSAAAAAICX4XFMHW0lisGt_629T1nd51rw';
	$config['security']['recaptcha_private_key'] = '6LcdGusSAAAAAP2CgZKygVwjT79hqVhXcTW-5C7x'; 
	...
	*/
	...
	$config['email']['site_title'] = "ECOPETIT";
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "web@ecopetit.cat";
