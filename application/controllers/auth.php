...
class Auth extends controlador {
    ...
    function __construct() 
    {
        ...
        if ($this->flexi_auth->is_logged_in_via_password() && uri_string() != $this->lang->lang().'/auth/logout') 
        {
    ...
    */
    ...
    {   
        ...
        //$this->load->view('users/login', $this->data);
                    ...
                    //$this->load->view('users/login_via_ajax_view', $this->data);
    ...
    function resend_activation_token()
    {
        ...
        if ($this->input->post('send_activation_token')) 
        {
            ...
            $this->lang->load('user');
            $this->load->model('demo_auth_model');
            $titol = lang('user.titleActiva');
            
            $this->demo_auth_model->resend_activation_token($titol);
        ...
        //$this->load->view('demo/public_examples/resend_activation', $this->data);     
        ...
        $data['main_template']  = 'users/resend_activation';
        $data['title'] = lang('user.titleResend');
		$data['description'] = '';
        //$this->load->library('flexi_auth');               
        $this->load->view('main_template', $data);  
        //$this->load->view('users/scripts');
    ...
    function forgotten_password()
    {
        ...
        $data['main_template']  = 'users/forgot_password';
        $data['title'] = lang('user.titleForgot');
		$data['description'] = '';
        //$this->load->library('flexi_auth');               
        $this->load->view('main_template', $data);  
